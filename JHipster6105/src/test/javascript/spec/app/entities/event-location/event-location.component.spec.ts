...
import { EventLocationComponent } from 'app/entities/event-location/event-location.component';
...
describe('Component Tests', () => {
  describe('EventLocation Management Component', () => {
    let comp: EventLocationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EventLocationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.eventLocations && comp.eventLocations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
