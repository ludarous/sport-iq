...
import { UserActivityResultComponent } from 'app/entities/user-activity-result/user-activity-result.component';
...
describe('Component Tests', () => {
  describe('UserActivityResult Management Component', () => {
    let comp: UserActivityResultComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserActivityResultComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new UserActivityResult(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.userActivityResults && comp.userActivityResults[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
