...
describe('Service Tests', () => {
  describe('UserActivity Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new UserActivity(0, 'AAAAAAA', currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a UserActivity', () => {
        ...
        service.create(new UserActivity()).subscribe(resp => (expectedResult = resp.body));
