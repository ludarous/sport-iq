...
export class UserActivityResultUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    ...
    value: [],
    compareValue: [],
    activityResult: [null, Validators.required],
    userActivity: [],
  });
  ...
  updateForm(userActivityResult: IUserActivityResult): void {
    this.editForm.patchValue({
      ...
      activityResult: userActivityResult.activityResult,
      userActivity: userActivityResult.userActivity,
    });
  }
  ...
  private createFromForm(): IUserActivityResult {
    return {
      ...
      userActivity: this.editForm.get(['userActivity'])!.value,
    };
  }
