...
export class ActivityResultSplitComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.activityResultSplitService
      ...
      .subscribe(
        (res: HttpResponse<IActivityResultSplit[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IActivityResultSplit[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
