...
export class AgreementComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.agreementService
      ...
      .subscribe(
        (res: HttpResponse<IAgreement[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInAgreements(): void {
    this.eventSubscriber = this.eventManager.subscribe('agreementListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IAgreement[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
