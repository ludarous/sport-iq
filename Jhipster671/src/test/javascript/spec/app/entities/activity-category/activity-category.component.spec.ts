...
import { ActivityCategoryComponent } from 'app/entities/activity-category/activity-category.component';
...
describe('Component Tests', () => {
  describe('ActivityCategory Management Component', () => {
    let comp: ActivityCategoryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ActivityCategoryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.activityCategories && comp.activityCategories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
