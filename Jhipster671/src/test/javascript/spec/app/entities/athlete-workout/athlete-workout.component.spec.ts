...
import { AthleteWorkoutComponent } from 'app/entities/athlete-workout/athlete-workout.component';
...
describe('Component Tests', () => {
  describe('AthleteWorkout Management Component', () => {
    let comp: AthleteWorkoutComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AthleteWorkoutComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.athleteWorkouts && comp.athleteWorkouts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
