...
import { AthleteEventComponent } from 'app/entities/athlete-event/athlete-event.component';
...
describe('Component Tests', () => {
  describe('AthleteEvent Management Component', () => {
    let comp: AthleteEventComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AthleteEventComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.athleteEvents && comp.athleteEvents[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
