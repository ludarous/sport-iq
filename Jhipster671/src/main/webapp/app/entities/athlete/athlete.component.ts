...
export class AthleteComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.athleteService
      ...
      .subscribe(
        (res: HttpResponse<IAthlete[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInAthletes(): void {
    this.eventSubscriber = this.eventManager.subscribe('athleteListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IAthlete[] | null, headers: HttpHeaders, page: number): void {
