...
export class AthleteActivityComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.athleteActivityService
                ...
                .subscribe(
                    (res: HttpResponse<IAthleteActivity[]>) => this.paginateAthleteActivities(res.body, res.headers),
    ...
    trackId(index: number, item: IAthleteActivity) {
        return item.id;
    }

    registerChangeInAthleteActivities() {
        this.eventSubscriber = this.eventManager.subscribe('athleteActivityListModification', response => this.loadAll());
    }
    ...
    private paginateAthleteActivities(data: IAthleteActivity[], headers: HttpHeaders) {
