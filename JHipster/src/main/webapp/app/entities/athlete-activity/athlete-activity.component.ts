...
export class AthleteActivityComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.athleteActivityService
        ...
        .subscribe((res: HttpResponse<IAthleteActivity[]>) => this.paginateAthleteActivities(res.body, res.headers));
      return;
    }
    this.athleteActivityService
      .query({
  ...
  registerChangeInAthleteActivities() {
    this.eventSubscriber = this.eventManager.subscribe('athleteActivityListModification', () => this.loadAll());
  }

  delete(athleteActivity: IAthleteActivity) {
  ...
  protected paginateAthleteActivities(data: IAthleteActivity[], headers: HttpHeaders) {
