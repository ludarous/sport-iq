...
export class ActivityCategoryComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.activityCategoryService
                ...
                .subscribe(
                    (res: HttpResponse<IActivityCategory[]>) => this.paginateActivityCategories(res.body, res.headers),
    ...
    registerChangeInActivityCategories() {
        this.eventSubscriber = this.eventManager.subscribe('activityCategoryListModification', response => this.loadAll());
    }
    ...
    private paginateActivityCategories(data: IActivityCategory[], headers: HttpHeaders) {
