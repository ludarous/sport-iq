...
export class AthleteComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.athleteService
        ...
        .subscribe((res: HttpResponse<IAthlete[]>) => this.paginateAthletes(res.body, res.headers));
      return;
    }
    this.athleteService
      .query({
  ...
  registerChangeInAthletes() {
    this.eventSubscriber = this.eventManager.subscribe('athleteListModification', () => this.loadAll());
  }

  delete(athlete: IAthlete) {
  ...
  protected paginateAthletes(data: IAthlete[], headers: HttpHeaders) {
