...
export class ActivityResultSplitComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.activityResultSplitService
                ...
                .subscribe(
                    (res: HttpResponse<IActivityResultSplit[]>) => this.paginateActivityResultSplits(res.body, res.headers),
    ...
    registerChangeInActivityResultSplits() {
        this.eventSubscriber = this.eventManager.subscribe('activityResultSplitListModification', response => this.loadAll());
    }
    ...
    private paginateActivityResultSplits(data: IActivityResultSplit[], headers: HttpHeaders) {
