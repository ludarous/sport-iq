...
export class AthleteEventComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.athleteEventService
                ...
                .subscribe(
                    (res: HttpResponse<IAthleteEvent[]>) => this.paginateAthleteEvents(res.body, res.headers),
    ...
    registerChangeInAthleteEvents() {
        this.eventSubscriber = this.eventManager.subscribe('athleteEventListModification', response => this.loadAll());
    }
    ...
    private paginateAthleteEvents(data: IAthleteEvent[], headers: HttpHeaders) {
