...
export class EventLocationService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/event-locations';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IEventLocation[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
