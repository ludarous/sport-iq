...
export class AthleteActivityResultComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.athleteActivityResultService
                ...
                .subscribe(
                    (res: HttpResponse<IAthleteActivityResult[]>) => this.paginateAthleteActivityResults(res.body, res.headers),
    ...
    registerChangeInAthleteActivityResults() {
        this.eventSubscriber = this.eventManager.subscribe('athleteActivityResultListModification', response => this.loadAll());
    }
    ...
    private paginateAthleteActivityResults(data: IAthleteActivityResult[], headers: HttpHeaders) {
