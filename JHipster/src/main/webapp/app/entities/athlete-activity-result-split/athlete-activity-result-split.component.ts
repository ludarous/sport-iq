...
export class AthleteActivityResultSplitComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.athleteActivityResultSplitService
                ...
                .subscribe(
                    (res: HttpResponse<IAthleteActivityResultSplit[]>) => this.paginateAthleteActivityResultSplits(res.body, res.headers),
    ...
    registerChangeInAthleteActivityResultSplits() {
        this.eventSubscriber = this.eventManager.subscribe('athleteActivityResultSplitListModification', response => this.loadAll());
    }
    ...
    private paginateAthleteActivityResultSplits(data: IAthleteActivityResultSplit[], headers: HttpHeaders) {
