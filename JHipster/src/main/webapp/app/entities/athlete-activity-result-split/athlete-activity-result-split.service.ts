...
export class AthleteActivityResultSplitService {
    private resourceUrl = SERVER_API_URL + 'api/athlete-activity-result-splits';
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/athlete-activity-result-splits';
