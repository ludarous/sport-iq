...
export class ActivityResultComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.activityResultService
                ...
                .subscribe(
                    (res: HttpResponse<IActivityResult[]>) => this.paginateActivityResults(res.body, res.headers),
    ...
    trackId(index: number, item: IActivityResult) {
        return item.id;
    }
    ...
    private paginateActivityResults(data: IActivityResult[], headers: HttpHeaders) {
