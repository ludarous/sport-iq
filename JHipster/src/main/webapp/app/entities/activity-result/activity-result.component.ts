...
export class ActivityResultComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.activityResultService
        ...
        .subscribe((res: HttpResponse<IActivityResult[]>) => this.paginateActivityResults(res.body, res.headers));
      return;
    }
    this.activityResultService
      .query({
  ...
  registerChangeInActivityResults() {
    this.eventSubscriber = this.eventManager.subscribe('activityResultListModification', () => this.loadAll());
  }

  delete(activityResult: IActivityResult) {
  ...
  protected paginateActivityResults(data: IActivityResult[], headers: HttpHeaders) {
