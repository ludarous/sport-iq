...
describe('Service Tests', () => {
    describe('Sport Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SportService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/sports';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Sport', () => {
                service.create(new Sport(null)).subscribe(received => {
            ...
            it('should update a Sport', () => {
                service.update(new Sport(123)).subscribe(received => {
