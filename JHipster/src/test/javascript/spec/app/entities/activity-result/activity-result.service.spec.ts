    ...
    describe('ActivityResult Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a ActivityResult', () => {
                service.create(new ActivityResult(null)).subscribe(received => {
            ...
            it('should update a ActivityResult', () => {
                service.update(new ActivityResult(123)).subscribe(received => {
            ...
            it('should return a ActivityResult', () => {
            ...
            it('should return a list of ActivityResult', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new ActivityResult(123)]);
            });
