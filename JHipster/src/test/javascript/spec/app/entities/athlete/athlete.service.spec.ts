    ...
    describe('Athlete Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/athletes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Athlete', () => {
                service.create(new Athlete(null)).subscribe(received => {
            ...
            it('should update a Athlete', () => {
                service.update(new Athlete(123)).subscribe(received => {
