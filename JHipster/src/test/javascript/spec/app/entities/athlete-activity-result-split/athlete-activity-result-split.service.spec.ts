    ...
    describe('AthleteActivityResultSplit Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/athlete-activity-result-splits';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a AthleteActivityResultSplit', () => {
                service.create(new AthleteActivityResultSplit(null)).subscribe(received => {
            ...
            it('should update a AthleteActivityResultSplit', () => {
                service.update(new AthleteActivityResultSplit(123)).subscribe(received => {
            ...
            it('should return a AthleteActivityResultSplit', () => {
            ...
            it('should return a list of AthleteActivityResultSplit', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new AthleteActivityResultSplit(123)]);
            });
