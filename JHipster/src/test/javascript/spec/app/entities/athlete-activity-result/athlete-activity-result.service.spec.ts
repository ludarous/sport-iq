    ...
    describe('AthleteActivityResult Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/athlete-activity-results';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a AthleteActivityResult', () => {
                service.create(new AthleteActivityResult(null)).subscribe(received => {
            ...
            it('should update a AthleteActivityResult', () => {
                service.update(new AthleteActivityResult(123)).subscribe(received => {
            ...
            it('should return a AthleteActivityResult', () => {
            ...
            it('should return a list of AthleteActivityResult', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new AthleteActivityResult(123)]);
            });
