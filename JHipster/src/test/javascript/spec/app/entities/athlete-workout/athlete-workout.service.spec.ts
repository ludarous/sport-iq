    ...
    describe('AthleteWorkout Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/athlete-workouts';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a AthleteWorkout', () => {
                service.create(new AthleteWorkout(null)).subscribe(received => {
            ...
            it('should update a AthleteWorkout', () => {
                service.update(new AthleteWorkout(123)).subscribe(received => {
            ...
            it('should return a AthleteWorkout', () => {
            ...
            it('should return a list of AthleteWorkout', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new AthleteWorkout(123)]);
            });
