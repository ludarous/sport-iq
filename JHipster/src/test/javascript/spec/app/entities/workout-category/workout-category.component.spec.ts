...
import { WorkoutCategoryComponent } from 'app/entities/workout-category/workout-category.component';
...
describe('Component Tests', () => {
    describe('WorkoutCategory Management Component', () => {
        let comp: WorkoutCategoryComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(WorkoutCategoryComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.workoutCategories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
