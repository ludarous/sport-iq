    ...
    describe('AthleteEvent Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/athlete-events';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a AthleteEvent', () => {
                service.create(new AthleteEvent(null)).subscribe(received => {
            ...
            it('should update a AthleteEvent', () => {
                service.update(new AthleteEvent(123)).subscribe(received => {
            ...
            it('should return a AthleteEvent', () => {
            ...
            it('should return a list of AthleteEvent', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new AthleteEvent(123)]);
            });
