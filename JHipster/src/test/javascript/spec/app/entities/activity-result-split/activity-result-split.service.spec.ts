    ...
    describe('ActivityResultSplit Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/activity-result-splits';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a ActivityResultSplit', () => {
                service.create(new ActivityResultSplit(null)).subscribe(received => {
            ...
            it('should update a ActivityResultSplit', () => {
                service.update(new ActivityResultSplit(123)).subscribe(received => {
            ...
            it('should return a ActivityResultSplit', () => {
            ...
            it('should return a list of ActivityResultSplit', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new ActivityResultSplit(123)]);
            });
