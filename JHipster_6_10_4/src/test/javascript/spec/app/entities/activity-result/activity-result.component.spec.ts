...
import { ActivityResultComponent } from 'app/entities/activity-result/activity-result.component';
...
describe('Component Tests', () => {
  describe('ActivityResult Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.activityResults && comp.activityResults[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
