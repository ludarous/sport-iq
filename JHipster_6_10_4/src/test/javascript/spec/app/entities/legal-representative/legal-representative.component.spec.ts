...
import { LegalRepresentativeComponent } from 'app/entities/legal-representative/legal-representative.component';
...
describe('Component Tests', () => {
  describe('LegalRepresentative Management Component', () => {
    let comp: LegalRepresentativeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LegalRepresentativeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new LegalRepresentative(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.legalRepresentatives && comp.legalRepresentatives[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
