...
import { UserActivityDeleteDialogComponent } from 'app/entities/user-activity/user-activity-delete-dialog.component';
  ...
  describe('UserActivity Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [UserActivityDeleteDialogComponent],
      })
