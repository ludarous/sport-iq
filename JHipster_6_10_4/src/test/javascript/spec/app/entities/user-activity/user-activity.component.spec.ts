...
import { UserActivityComponent } from 'app/entities/user-activity/user-activity.component';
...
describe('Component Tests', () => {
  describe('UserActivity Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userActivities && comp.userActivities[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
