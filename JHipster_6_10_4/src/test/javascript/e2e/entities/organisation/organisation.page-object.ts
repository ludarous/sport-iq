...
export class OrganisationComponentsPage {
  ...
  deleteButtons = element.all(by.css('jhi-organisation div table .btn-danger'));
...
export class OrganisationDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-organisation-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-organisation'));
