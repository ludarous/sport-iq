...
public class LegalRepresentativeResourceIT {
    ...
    public void createLegalRepresentative() throws Exception {
        ...
        LegalRepresentativeDTO legalRepresentativeDTO = legalRepresentativeMapper.toDto(legalRepresentative);
        restLegalRepresentativeMockMvc.perform(post("/api/legal-representatives").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(legalRepresentativeDTO)))
    ...
    public void updateLegalRepresentative() throws Exception {
        ...
        updatedLegalRepresentative
            ...
            .email(UPDATED_EMAIL)
            .phone(UPDATED_PHONE);
        LegalRepresentativeDTO legalRepresentativeDTO = legalRepresentativeMapper.toDto(updatedLegalRepresentative);

        restLegalRepresentativeMockMvc.perform(put("/api/legal-representatives").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(legalRepresentativeDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteLegalRepresentative() throws Exception {
        ...
        restLegalRepresentativeMockMvc.perform(delete("/api/legal-representatives/{id}", legalRepresentative.getId()).with(csrf())
