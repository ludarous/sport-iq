...
public class BodyCharacteristicsResourceIT {
    ...
    @Autowired
    private BodyCharacteristicsService bodyCharacteristicsService;
    ...
    public void createBodyCharacteristics() throws Exception {
        ...
        BodyCharacteristicsDTO bodyCharacteristicsDTO = bodyCharacteristicsMapper.toDto(bodyCharacteristics);
        restBodyCharacteristicsMockMvc.perform(post("/api/body-characteristics").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(bodyCharacteristicsDTO)))
    ...
    public void updateBodyCharacteristics() throws Exception {
        ...
        updatedBodyCharacteristics
            ...
            .weight(UPDATED_WEIGHT)
            .date(UPDATED_DATE);
        BodyCharacteristicsDTO bodyCharacteristicsDTO = bodyCharacteristicsMapper.toDto(updatedBodyCharacteristics);

        restBodyCharacteristicsMockMvc.perform(put("/api/body-characteristics").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(bodyCharacteristicsDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteBodyCharacteristics() throws Exception {
        ...
        restBodyCharacteristicsMockMvc.perform(delete("/api/body-characteristics/{id}", bodyCharacteristics.getId()).with(csrf())
