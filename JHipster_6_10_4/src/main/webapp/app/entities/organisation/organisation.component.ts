...
export class OrganisationComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.organisationService
      ...
      .subscribe(
        (res: HttpResponse<IOrganisation[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IOrganisation[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
