...
export class ActivityResultComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.activityResultService
      ...
      .subscribe(
        (res: HttpResponse<IActivityResult[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IActivityResult[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
