...
export class UserActivityResultSplitUpdateComponent implements OnInit {
  ...
  updateForm(userActivityResultSplit: IUserActivityResultSplit): void {
    this.editForm.patchValue({
      ...
      activityResultSplitId: userActivityResultSplit.activityResultSplitId,
      userActivityResultId: userActivityResultSplit.userActivityResultId,
    });
  }
  ...
  private createFromForm(): IUserActivityResultSplit {
    return {
      ...
      userActivityResultId: this.editForm.get(['userActivityResultId'])!.value,
    };
  }
