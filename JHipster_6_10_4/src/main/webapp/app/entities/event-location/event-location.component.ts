...
export class EventLocationComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.eventLocationService
      ...
      .subscribe(
        (res: HttpResponse<IEventLocation[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IEventLocation[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
